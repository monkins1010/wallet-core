...
export class ILiqualityHTLC__factory {
  static readonly abi = _abi;
  static createInterface(): ILiqualityHTLCInterface {
    return new utils.Interface(_abi) as ILiqualityHTLCInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ILiqualityHTLC {
    return new Contract(address, _abi, signerOrProvider) as ILiqualityHTLC;
  }
}
